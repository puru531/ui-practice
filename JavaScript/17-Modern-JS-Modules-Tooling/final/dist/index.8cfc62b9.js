...
(0, _shoppingCartJsDefault.default)(5, "Pizza");
(0, _shoppingCartJsDefault.default)(2, "Burger");
(0, _shoppingCartJsDefault.default)(3, "Momos");
console.log((0, _shoppingCartJs.cart)); // o/p   0: {product: 'Pizza', quantity: 5} 1: {product: 'Burger', quantity: 2} 2: {product: 'Momos', quantity: 3}
const state = {
    cart: [
        {
            product: "bread",
...
const stateDeepClone = (0, _cloneDeepJsDefault.default)(state); //COpied in a new object, and any change in one will not affect other.
...
exports.default = function(quantity, product) {
    cart.push({
        product,
        quantity
    });
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dpgAG","6rimH"], "6rimH", "parcelRequire46e4")
