...
describe('FooterComponent', () => {
  ...
  describe('component visibility', () => {
    it('should hide footer when there is no do item', () => {
  ...
  describe('counters', () => {
    it('renders counter for 1 todo', () => {
      ...
      expect(count.nativeElement.textContent).toContain('1 item left');
    });
    ...
    it('renders counter for 2 todos', () => {
      ...
      expect(count.nativeElement.textContent).toContain('2 items left');
    });
  });
  describe('filters', () => {
    it('should highlight deafult filter', () => {
    ...
    it('should highlight changed filter', () => {
