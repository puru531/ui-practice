...
@Component({ // Component decorator is used to define a component and its metadata, such as the selector, template, and styles.
  ...
  standalone: true, // The standalone property is a boolean that indicates whether the component is a standalone component or a part of a larger component.
