...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    delete:
      'inline-block text-sm rounded-full bg-red-200 font-semibold uppercase tracking-wide text-red-800 transition-colors duration-300 hover:bg-red-300 focus:bg-red-300 focus:outline-none focus:ring focus:ring-red-300 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2 md:px-5 md:py-2.5 text-xs',
  };
  if (to)
    return (
